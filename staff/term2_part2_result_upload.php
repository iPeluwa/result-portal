...
if (isset($_POST["import"])) {
    ...
    // else{
            ...
            $sqlInsert = "UPDATE term2 SET note2 = '" . $column[3] . "', project2 = '" . $column[4] . "', test2 = '" . $column[5] . "', exam = '" . $column[6] . "' WHERE `student_id`='$student_id' AND subject_id='$subject' AND session_id='$current_session_id'";
