                                                  ...
                                                  <td><?php echo $query ['subject']; ?></td>
                                                        <td><div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-right" role="menu">
                                                                    <li><a href="term2_part1_result_upload.php?class=<?php echo $query1['id'];?> & subject=<?php echo $query['id'];?>"> <i class="fa fa-fw fa-cloud-upload"></i> Upload Mid-Term Result</a></li>
                                                                    <li><a href="term2_part2_result_upload.php?class=<?php echo $query1['id'];?> & subject=<?php echo $query['id'];?>"> <i class="fa fa-fw fa-cloud-upload"></i> Upload Full-Term Result</a></li>
