  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <h1>HOD's Report</h1>
               <div class="col-12" id="hod_report">
              ...
              <div class="col-md-10 offset-1">
                ...
                <select  class="form-control" name="recepient">
                      <?php 
                          ...
                          $select_hod = "SELECT `id`,`name` FROM `admin` WHERE `Category` = 'HOD'";
                          $query_select_hod = mysqli_query($con, $select_hod);
                        while($query_hod = mysqli_fetch_assoc($query_select_hod)){
                          $hod_id = $query_hod['id']; $hod_name = $query_hod['name'];
                          echo "<option value='$hod_id'>$hod_name</option>";
