 ...
 ?>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
    <button type="button"data-toggle="modal" data-target="#send_message" class="btn btn-primary pull-right">Send Message</button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="delete">Send Message</h5>
              ...
              <div class="col-md-10 offset-1">
                ...
                <select class="form-control" name="recepient">
                      <?php 
                          ...
                          $select = "SELECT `HOD_id`,`Category` FROM `hod_category`";
                          $query_select = mysqli_query($con, $select);
                        while($query1 = mysqli_fetch_assoc($query_select)){

                          $hod_id = $query1['HOD_id'];
                          $get = "SELECT `name` FROM `admin` WHERE `Category`='HOD' AND `id`='$hod_id'";
                        $query_get = mysqli_query($con,$get);

                        while ($query2 = mysqli_fetch_assoc($query_get)){
                          $hod_name = $query2['name'];
                        echo  "<option value='$hod_id'>$hod_name"." of "."{$query1['Category']}</option>"; 
                       } 
                      }
                      ?>
                     </select>
