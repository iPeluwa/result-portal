      ...
      <table class="table table-striped table-bordered table-hover">
       ...
       <tbody>
         ...
         if(!isset($_POST['search'])){
          $get = "SELECT * FROM `accounts` WHERE `date_left` = ''";
          ...
          <?php }}
            ...
            if(isset($_POST['search'])){
              ...
              $get_search = "SELECT * FROM `accounts` WHERE `date_left` = '' AND (`name` LIKE '%".$search_name."%') ORDER BY `id` DESC";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="delete">Delete Account Record</h5>
...
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="changemail">Create a New Accounts</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" type="text" name="position" required = 'required' placeholder="Position(e.g Accountant)">
          </div>
      ...
      <div class="form-group">
        <div class="form-row">
         <div class="col-md-6">
          ...
          <input class="form-control" type="number" name="phonenumber" min="1" oninput = "validity.valid || (value = '')" required = 'required' placeholder="Phone Number">
        </div>        
      </div>
    </div>
    <br>
        ...
        <form method="post" action="">
         ...
         <div class="form-group">
          ...
          <div class="col-md-6">
            ...
            <input type = 'text' class='form-control' name="new_position" placeholder='Category' required = 'required'/> 
          </div>
        </div>
      </div>
      <div class="modal-footer">
