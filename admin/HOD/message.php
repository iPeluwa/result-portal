  ...
  <div class="container-fluid">
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      <div class="col-md-10 offset-1">
                        <label for="exampleInputName">Send</label>
                      ...
                      <div class="form-row">
                        <div class="col-md-10 offset-1">
                          ...
                          <select class="form-control" name="recepient">
                            ...
                            $get = "SELECT `id`,`name` FROM `admin` WHERE `Category`='Principal'";
                            $query_get = mysqli_query($con,$get);

                            while ($query = mysqli_fetch_assoc($query_get)){
                              $name = $query['name'];
                              $id = $query['id'];
                              echo  "<option value='$id'>{$query['name']}</option>"; 
                            }
                            ?>
                          </select>
                        </div>
    ...
    <div class='col-8 offset-2'>
      ...
      while($row = mysqli_fetch_assoc($query_select_message)){
        ...
        $row_teacher = mysqli_fetch_assoc($select_sender_query);
