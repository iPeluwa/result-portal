          ...
          <div class="form-group">
           <div class="form-row">
            ...
            <div class="col-md-6">
             ...
             <input class="form-control" type="number" name="number" min ="1"  oninput ="validity.valid ||(value = '')" required = "required" placeholder="Enter new number">
           </div>
