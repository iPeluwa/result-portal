            ...
            <div class="form-row">
              <div class="col-md-10 offset-1">
                ...
                <select  class="form-control" name="recepient">
                  ...
                  $select_principal = "SELECT `id`,`name` FROM `admin` WHERE `Category` = 'Principal' AND `date_left` = ''";
                  $query_select_principal = mysqli_query($con, $select_principal);
                  while($query_principal = mysqli_fetch_assoc($query_select_principal)){
                    $principal_id = $query_principal['id']; $principal_name = $query_principal['name'];
