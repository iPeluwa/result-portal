...
session_start();
$admin_category = $_SESSION['PRINCIPAL_CATEGORY'];
if(!isset($_SESSION['PRINCIPAL_ID'])){
 header("location: ../index.php");
}

$userid =$_SESSION['PRINCIPAL_ID'];
$username =$_SESSION['PRINCIPAL_NAME'];
$email =$_SESSION['PRINCIPAL_EMAIL'];
$phone =$_SESSION['PRINCIPAL_PHONE'];
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="home.php">Principals</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="HOD's Reports">
          <a class="nav-link" href="hod_report.php">
            <i class="fa fa-fw fa-book"></i>
            <span class="nav-link-text">HOD's Reports</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="HOD's Reports">
          <a class="nav-link" href="proprietor_report.php">
            <i class="fa fa-fw fa-book"></i>
            <span class="nav-link-text">Proprietor's Reports</span>
          </a>
        </li>
