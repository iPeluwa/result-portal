  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        ...
        <h1>Update Principal's Information</h1>
          ...
          <div class="form-group">
           <div class="form-row">
            ...
            <div class="col-md-6">
             ...
             <input class="form-control" required="required" type="number" min='1' oninput="validity.valid || (value='')" name="number" placeholder="Enter new number">
           </div>
           
           <div class="col-md-6">
             <label for="exampleInputPassword1">Password</label>
             <input class="form-control" required="required" type="password" name="password" placeholder="Enter password">
           </div>
         </div>
          ...
          <div class="form-group">
           <div class="form-row">
            ...
            <div class="col-md-6">
             ...
             <input class="form-control" required="required" type="password" name="old_password" placeholder="Enter old password">
           </div>
           
           <div class="col-md-6">
             <label for="exampleInputPassword1">New Password</label>
             <input class="form-control" required="required" type="password" name="new_password" placeholder="Enter new password">
           </div>
         </div>
