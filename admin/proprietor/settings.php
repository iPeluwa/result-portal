  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        ...
        <h1>Update Proprietor Information</h1>
          ...
          <div class="form-group">
           <div class="form-row">
            ...
            <div class="col-md-6">
             ...
             <input class="form-control" type="number" required = "required" min="1" oninput = "validity.valid || (value = '')" name="number" placeholder="Enter new number">
           </div>
