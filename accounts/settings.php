  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <h1>Update Accounts Information</h1>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body"><!--Change Category Section -->
           ...
           <div class="modal-footer">
            ...
            <button class="btn btn-primary" type="submit" name="change_account_name">Create</button>
          </div>
        </form>
      </div>
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"><!--Change Category Section -->
          ...
          <div class="form-group">
           <div class="form-row">
            ...
            <div class="col-md-6">
             ...
             <input class="form-control" type="email" required = "required" name="new_email" placeholder="Enter new email">
           </div>
       ...
       <div class="modal-footer">
        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
        <button class="btn btn-primary" type="submit" name="change_account_email">Create</button>
      </div>
    </form>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"><!--Change Category Section -->
          ...
          <div class="form-group">
           <div class="form-row">
            ...
            <div class="col-md-6">
             ...
             <input class="form-control" type="number" min="1"  oninput = "validity.valid ||(value = '')" required = "required" name="number" placeholder="Enter new number">
           </div>
       ...
       <div class="modal-footer">
        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
        <button class="btn btn-primary" type="submit" name="change_account_number">Create</button>
      </div>
    </form>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"><!--Change Category Section -->
          ...
          <div class="form-group">
           <div class="form-row">
            ...
            <div class="col-md-6">
             ...
             <input class="form-control" type="password" required = "required" name="old_password" placeholder="Enter old password">
           </div>
           
           <div class="col-md-6">
             <label for="exampleInputPassword1">New Password</label>
             <input class="form-control" type="password" required = "required" name="new_password" placeholder="Enter new password">
           </div>
         </div>
       ...
       <div class="modal-footer">
        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
        <button class="btn btn-primary" type="submit" name="change_account_password">Create</button>
      </div>
    </form>
  </div>
</div>
