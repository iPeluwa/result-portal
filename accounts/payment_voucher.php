  ...
  <div class="container-fluid">    <!-- /.content-wrapper-->
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class = "col-12">
         ...
         <div class="form-group">
          ...
          <form action ='pv_insert.php' method='post'>
               ...
               <div class="form-group">
                <div class="form-row">
                  <div class="col-md-10 offset-1">
                    ...
                    <textarea class='form-control' name='description' required='required' type='text'></textarea>
                  </div>
                </div>
              </div>
            </td>
              ...
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-10 offset-1">
                    ...
                    <input type="number" min='1' required = 'required' class='form-control' name="amt" oninput="validity.valid||(value='')" />
                  </div>      
                </div>
              </div>
            </td>
      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col-md-4 ">
            ...
            <input type="number" class='form-control' min='1' required = 'required' name="cheque_num" oninput="validity.valid||(value='')" />
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
         <div class="col-md-3 ">       
           <button class='btn btn-success ' type='submit' name='create_pv'>Create Payment Voucher</button>
         </div>
       </div>
